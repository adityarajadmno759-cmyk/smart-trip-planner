        ...
        <div className={styles.authPage}>
            <div className={styles.authCard}>
                <div className={styles.authHeader}>
                    ...
                    <p className="text-secondary" style={{ fontSize: '14px' }}>Start planning smarter trips today</p>
                </div>
                ...
                <p className={styles.authFooter}>
                    Already have an account? <Link href="/auth/login" style={{ color: 'var(--brand-primary)' }}>Sign in →</Link>
                </p>
            </div>
        </div>
    );
